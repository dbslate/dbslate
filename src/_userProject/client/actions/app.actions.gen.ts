...
src/_userProject/defs/app.def.json
    |> tsActionWriter
...
import * as t from '../types/app.types.gen';
...
export const signInUser = (email: string, password: string): t.SignInUserAction => ({
...
export const executeSuccessQuery = (id: t.Id, results: string): t.ExecuteSuccessQueryAction => ({
