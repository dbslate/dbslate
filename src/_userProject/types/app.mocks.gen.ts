...
export const mockResolvedQuery = (): t.ResolvedQuery => ({
  ...
  raw: rand.str(),
  lastExecuted: rand.str(),
  results: sample([sample([true, false]) as boolean, null, rand.num(), {}, rand.str()]) as
    | boolean
    | null
    | number
    | {}
...
export const mockMessageType = (): t.MessageType =>
  sample([t.MessageType.InitMessage, t.MessageType.ActionPerformedMessage]) as t.MessageType;
